...
const middleNums = numbers.splice(3,3)
...
const filtered = myNumbers.filter(e > 100)

//////////////////PROBLEM 16////////////////////

// Next up, reduce to get the total of the array. call the new array 'total'

const total = myNumbers.reduce(function(acc,val){
	return acc + val
})
...
const forTheLoveOfGeorge = notGeorge.map(function georgeMaker(e){
	e = 'George'
})
...
const totallyAwesome = people.awesomeLevel.reduce(function(acc, val){
return acc + val
})
